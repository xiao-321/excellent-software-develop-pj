...
<body>
      ...
      <div class="logo_right">
        <nav class="nav">
          <ul>
            ...
            <li><a href="${pageContext.request.contextPath}/new" class="active">Latest</a></li>
          </ul>
        </nav>
        <div class="search">
  ...
  <!--banner end-->
  <div class="head_bar">
    <span>Location：</span><a href="${pageContext.request.contextPath}/index">Home </a> > <span class="active" style=" color:#00BBFF;">Latest</span>
  </div>
  <div class="comfor_con">
    <div class="top_tit">
      <div class="top_t"><a href="comfortable.jsp" style=" color:#00BBFF; font-size: 30px">Latest upload</a></div><br/>
    </div>
    <div class="com_shi">
      <br>
    </div>
