...
<body>
  ...
  <div class="head_bar">
    <span>Location：</span><a href="${pageContext.request.contextPath}/index">Home </a> > <span class="active" style=" color:#00BBFF;"> My sharing</span>
  </div>
  <div class="comfor_con">
    <div class="top_tit">
      <h1><a href="comfortable.jsp" style=" color:#00BBFF; font-weight: bold;">My sharing</a></h1><br/>
              ...
              <ul>
                ...
                <li>
                    <span class="icon-collection" aria-hidden="true" style="color: red">
                      <button style=" color:#00BBFF;" class="Collection" onclick="location.href = '/picEditor?type=update&id=${pro.id}'">Modify</button>
                    </span>
                    <span class="icon-collection" aria-hidden="true" style="color: red">
                      <button class="Collection" onclick="location.href = '/picEditor?type=delete&id=${pro.id}'">Delete</button>
                    </span>
                </li>
              </ul>
            </div>
