...
<div>
    ...
    <!--header-->
    <div id="search">
        <form id="updateform" action="javaScript:;" style="height: 565px;background-color: #E8E8E8;">
            <input name="id" value="${pro.id}" hidden>
            Title:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <input style="margin-left: 29px" name="title" type="text" placeholder="input something" required value="${pro.title}">
            Picture：<input id="file_upload" type="file"><br>
            Author：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input style="margin-left: 16px" name="author" type="text" placeholder="input something" required value="${pro.author}"><br>
            Theme：  &nbsp;&nbsp;&nbsp;&nbsp; <input style="margin-left: 16px" name="theme" type="text" placeholder="input something" required value="${pro.theme}"><br>
            Heat：    &nbsp;  <input style="margin-left: 45px" name="heat" type="number" placeholder="input something" required value="${pro.heat}"><br>
            Country:<input style="margin-left: 45px" name="state" type="text" placeholder="input something" required value="${pro.state}"><br>
            City：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;      <input style="margin-left: 15px;" type="text" name="city" placeholder="input something" required value="${pro.city}"><br>
            ...
            <img id="preview" src="${pro.img}" alt="try to upload a picture">
